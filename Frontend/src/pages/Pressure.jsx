    ...
    return (
        <div className='flex flex-col gap-6 p-4 h-full '>
          ...
          <div className='h-1/3 w-full flex flex-col justify-center items-center gap-3'>
            <span className='font-raleway text-black font-bold text-2xl'>Grafik Tekanan Angin</span>
            <Grafik  
            dataka={TABLE_ROWS} 
            value={"air"}
            x={"waktu"}/>    
          ...
          <span className='font-raleway text-black font-bold text-2xl'>Data Tekanan Angin</span>

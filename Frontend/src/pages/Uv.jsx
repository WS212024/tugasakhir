  ...
  return (
    <div className='flex flex-col gap-6 p-4 h-full '>
      ...
      <div className='h-1/3 w-full flex flex-col justify-center items-center gap-3'>
        <span className='font-raleway text-black font-bold text-2xl'>Grafik Index UV</span>
        <Grafik  
        dataka={tableRows} 
        value={"uv"}
        x={"waktu"}/>    
      ...
      className='h-2/3 flex flex-col justify-center items-center gap-3'>
        <span className='font-raleway text-black font-bold text-2xl'>Data Index UV</span>
